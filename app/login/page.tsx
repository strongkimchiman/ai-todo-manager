/**
 * 로그인 페이지 컴포넌트
 * - 이메일/비밀번호 입력 폼과 서비스 소개를 제공하는 로그인 화면입니다.
...
export const metadata: Metadata = {
  ...
  description: "AI 기반 할 일 관리 웹 서비스 로그인 페이지입니다.",
}
        ...
        <Card className="shadow-lg">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-xs">
                  자연어로 입력하고, Gemini AI가 할 일을 정리해주는 스마트 할 일 관리 서비스
                </p>
              </div>
            </div>

            <CardDescription className="text-sm">
              계정에 로그인하고, 오늘 해야 할 일을 한눈에 확인해보세요.
            </CardDescription>
          </CardHeader>
          ...
          <CardFooter className="flex flex-col gap-2 border-t pt-4 text-sm">
            ...
            <div className="flex items-center justify-between gap-2">
              <span>지금 바로 회원가입하고 AI 할 일 관리 기능을 사용해보세요.</span>
